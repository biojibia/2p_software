...
_declspec (dllexport) int32 scan(int32 xPixels,  int32 yPixels, double xZoom, double yZoom, int32 AIrate, int32 AOrate, int numChannels)
{
	...
	{ 
		case 1:
			sprintf(AIchannels, "Dev1/ai0\0");
			break;
		case 2:
			sprintf(AIchannels, "Dev1/ai0:1\0");
			break;
		case 3:
			sprintf(AIchannels, "Dev1/ai0:2\0");
			break;
		case 4:
			sprintf(AIchannels, "Dev1/ai0:3\0");
			break;
		default:
			sprintf(AIchannels, "Dev1/ai0\0:1");
			break;
	}
...
_declspec (dllexport) int32 backscan(int32 xPixels,  int32 yPixels, double xZoom, double yZoom, int32 AIrate, int32 AOrate)
{
	...
	// Set SCAN parameters
	bin = (int) (AIrate/AOrate);
	T = xPixels*0.10;									// Turn Around Pixels (10% of scan pixels)
	Tscale = (20.0*(T*T)/4.0);
